  ...
  return (
    <div className='notice'>
      ...
      <Card title='通知提醒框位置' style={{margin:'10px 0'}}>
        <Button type='primary' onClick={() => handleNotification('success','topLeft')}>
          Success
        </Button>
        <Button type='primary' onClick={() => handleNotification('info','topRight')}>
          Info
        </Button>
        <Button type='primary' onClick={() => handleNotification('warning','bottomLeft')}>
          Warning
        </Button>
        <Button type='primary' onClick={() => handleNotification('error','bottomRight')}>
          Error
        </Button>
      </Card>
    </div>
